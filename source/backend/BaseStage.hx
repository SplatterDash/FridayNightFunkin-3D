...
class BaseStage extends FlxBasic
{
	...
	public var boyfriend2(get, never):Character;
	...
	public var splitCam(get, never):FlxCamera;
	public var camHUD(get, never):FlxCamera;
	public var camOther(get, never):FlxCamera;

	public var defaultCamZoom(get, set):Float;
	public var currentCamZoom(get, set):Float;
	public var camFollow(get, never):FlxObject;

	public var girlfriendCameraOffset(get, never):Array<Float>;
	public var boyfriendCameraOffset(get, never):Array<Float>;
	public var opponentCameraOffset(get, never):Array<Float>;

	public var opponentStrums(get, never):FlxTypedGroup<StrumNote>;
	public var playerStrums(get, never):FlxTypedGroup<StrumNote>;
	...
	inline private function get_boyfriend2():Character return game.boyfriend2;
	...
	inline private function get_boyfriendCameraOffset():Array<Float> return game.boyfriendCameraOffset;
	inline private function get_opponentCameraOffset():Array<Float> return game.opponentCameraOffset;
	inline private function get_girlfriendCameraOffset():Array<Float> return game.girlfriendCameraOffset;
	...
	inline private function get_splitCam():FlxCamera return game.splitCam;
	...
	inline private function get_currentCamZoom():Float return game.currentCamZoom;
	inline private function set_currentCamZoom(value:Float):Float
	{
		game.currentCamZoom = value;
		return game.currentCamZoom;
	}
	inline private function get_camFollow():FlxObject return game.camFollow;
	inline private function get_opponentStrums():FlxTypedGroup<StrumNote> return game.opponentStrums;
	inline private function get_playerStrums():FlxTypedGroup<StrumNote> return game.playerStrums;
}