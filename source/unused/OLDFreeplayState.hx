...
class FreeplayState extends MusicBeatState
{
	var songs:Array<SongMetadata> = [
		...
		new SongMetadata("Citrus Bliss", 2, "3Mako_big", FlxColor.GREEN),
		new SongMetadata("TwinZ", 4, "3Josie", FlxColor.GRAY),
	...
	var cashBackSongs:Array<SongMetadata> = [
		...
		new SongMetadata("TwinZ (Euphoria Remix)", 4, "3Jitterbud", FlxColor.GRAY),
