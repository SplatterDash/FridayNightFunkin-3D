...
class GraphicsSettingsSubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		boyfriend = new Character(840, 170, '3DamiPLAYER', false);
		...
		var option:Option = new Option('Low Quality', //Name
			'If checked, disables crowd and sprite shader effects on songs.\nThis can decrease loading times and improve performance.', //Description
