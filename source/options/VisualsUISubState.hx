...
class VisualsUISubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		var noteSkins:Array<String> = ['Future', 'Chip'];
		...
		var noteSplashes:Array<String> = ['Diamond', 'Electric', 'Sparkles', 'Vanilla'];
	...
	function onChangePauseMusic()
	{
		if(ClientPrefs.data.pauseMusic == 'None')
			...
			FlxG.sound.playMusic(Paths.music(Paths.formatToSongPath(ClientPrefs.data.pauseMusic)), 1 * ClientPrefs.data.musicVolume);
	...
	{
		if(changedMusic && !OptionsState.onPlayState) FlxG.sound.playMusic(Paths.music('3dmainmenu'), 1 * ClientPrefs.data.musicVolume, true);
		super.destroy();
	}
