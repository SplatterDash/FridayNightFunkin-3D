...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		Conductor.bpm = 128.0;
		FlxG.sound.playMusic(Paths.music('offsetSong'), 1 * ClientPrefs.data.musicVolume, true);
	...
	override public function update(elapsed:Float)
	{
		...
		if(controls.BACK)
		{
			...
			else FlxG.sound.playMusic(Paths.music('3dmainmenu'), 1 * ClientPrefs.data.musicVolume);
